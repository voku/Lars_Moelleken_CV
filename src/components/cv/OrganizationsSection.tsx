...
export function OrganizationsSection() {
  ...
  return (
    <section id="organizations" aria-labelledby="orgs-heading">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 inline-flex items-center gap-3">
        ...
        <div>
          <h3 className="font-semibold text-gray-900">{copy.organizations.ugName}</h3>
          <p className="text-sm text-gray-500">{copy.organizations.ugDescription}</p>
        </div>
      </div>
    </section>
  );
