  ...
  return (
    <section aria-labelledby="orgs-heading">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 inline-flex items-center gap-3">
        ...
        <div>
          <h3 className="font-semibold text-gray-900">{UI_TEXT.organizations.ugName}</h3>
          <p className="text-sm text-gray-500">{UI_TEXT.organizations.ugDescription}</p>
        </div>
      </div>
    </section>
  );
