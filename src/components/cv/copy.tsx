...
const COPY_BY_LOCALE = {
  de: {
    ...
    pageHeader: {
      ...
      bullet3: "Maintainer mehrerer Open-Source-Bibliotheken",
      bullet4: "Fokus auf saubere Architektur, statische Analyse und wartbaren Code",
    },
    aboutSection: {
      heading: "Wer ist Lars Moelleken?",
      description: "Senior PHP Developer und PHP Architect aus Deutschland mit 20+ Jahren Erfahrung in der Entwicklung geschäftskritischer Systeme. Spezialisiert auf Symfony, Laravel, PHP 8.x, Docker, CI/CD, PHPUnit, PHPStan und OOP/SOLID. Open-Source Maintainer sowie technischer Autor und Architektur-Berater.",
      bullet1: "Symfony & Laravel Expert — REST APIs, GraphQL, Microservices, Event-Driven Architecture",
      bullet2: "Docker, Kubernetes, CI/CD (GitHub Actions, GitLab CI) — DevOps-Kenntnisse in modernen Deployment-Pipelines",
    ...
    openSourceSection: {
      description: "Lars Moelleken ist Maintainer mehrerer Open-Source-Bibliotheken im PHP-Ökosystem. Diese Libraries werden weltweit eingesetzt mit Fokus auf Performance, Sicherheit und Stabilität sowie langfristige Wartung.",
      today: "Heute",
...
const EN_OVERRIDES: Partial<CvCopy> = {
  ...
  pageHeader: {
    ...
    bullet3: "Maintainer of several open-source libraries",
    bullet4: "Focus on clean architecture, static analysis, and maintainable code",
  },
  aboutSection: {
    heading: "Who is Lars Moelleken?",
    description: "Senior PHP Developer and PHP Architect from Germany with 20+ years of experience developing business-critical systems. Specialized in Symfony, Laravel, PHP 8.x, Docker, CI/CD, PHPUnit, PHPStan, and OOP/SOLID. Open-source maintainer, technical author, and architecture consultant.",
    bullet1: "Symfony & Laravel Expert — REST APIs, GraphQL, Microservices, Event-Driven Architecture",
    bullet2: "Docker, Kubernetes, CI/CD (GitHub Actions, GitLab CI) — DevOps knowledge in modern deployment pipelines",
  ...
  openSourceSection: {
    description: "Lars Moelleken is the maintainer of several open-source libraries in the PHP ecosystem. These libraries are used worldwide with a focus on performance, security, stability, and long-term maintenance.",
    today: "Today",
