...
const COPY_BY_LOCALE = {
  de: {
    ...
    pageHeader: {
      subtitle: "Maintainer weitverbreiteter PHP Open-Source-Bibliotheken. Senior PHP Engineer spezialisiert auf Legacy-Modernisierung, statische Analyse und wartbare Backend-Architekturen.",
      ...
      bullet3: "Maintainer weitverbreiteter PHP-Bibliotheken (Millionen Packagist-Installs), eingesetzt in tausenden Anwendungen weltweit",
    ...
    aboutSection: {
      ...
      description: "Senior PHP Engineer, PHP Architect und Sysadmin aus Deutschland mit 20+ Jahren Erfahrung in der Entwicklung geschäftskritischer Systeme. Spezialisiert auf Symfony, Laravel, PHP 8.x, Docker, CI/CD, PHPUnit, PHPStan und OOP/SOLID. Open-Source Maintainer (Millionen Packagist-Installationen), technischer Autor und Architektur-Berater. Verfügbar für Remote-Rollen.",
      ...
      bullet5: "Legacy-Modernisierung, technische Schulden abbauen, Team-Lead und Mentoring",
    },
    whyHireSection: {
...
const EN_OVERRIDES: Partial<CvCopy> = {
  ...
  pageHeader: {
    subtitle: "Maintainer of widely used PHP open-source libraries. Senior PHP Engineer specialized in legacy modernization, static analysis, and maintainable backend architectures.",
    ...
    bullet3: "Maintainer of widely used PHP libraries (millions of Packagist installs) — used in thousands of applications worldwide",
  ...
  aboutSection: {
    ...
    description: "Senior PHP Engineer, PHP Architect, and Sysadmin from Germany with 20+ years of experience developing business-critical systems. Specialized in Symfony, Laravel, PHP 8.x, Docker, CI/CD, PHPUnit, PHPStan, and OOP/SOLID. Open-source maintainer (millions of Packagist installs), technical author, and architecture consultant. Available for remote roles.",
    bullet1: "Symfony & Laravel Expert — REST APIs, GraphQL, Microservices, Event-Driven Architecture",
    ...
    bullet5: "Legacy modernization, reducing technical debt, Team Lead and mentoring",
  },
  whyHireSection: {
