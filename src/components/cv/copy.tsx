...
const COPY_BY_LOCALE = {
  de: {
    navigation: {
      standard: [
        { href: "#impact-heading", label: "Engineering Impact", shortLabel: "Impact" },
        { href: "#experience-heading", label: "Erfahrung", shortLabel: "Erfahrung" },
        { href: "#open_source", label: "Open Source", shortLabel: "OSS" },
        { href: "#skills-heading", label: "Skills", shortLabel: "Skills" },
    ...
    sharedProfileMission: {
      defaultIntro: "Entwicklung geschäftskritischer Systeme mit PHP 8.x, strikt typisierten Architekturen (Value Objects, Enums), PHPStan max, CI/CD und einer eigenen Agent-Engineering-Toolchain. Verantwortung für Architektur, Wartbarkeit und Teamführung.",
    },
    rolePositioning: {
    ...
    geoFaq: {
      ...
      a1: "Senior PHP Developer und Software-Architekt mit 20+ Jahren Erfahrung. Fokus auf strikt typisierte Architekturen (Value Objects, Enums), PHPStan auf maximalem Level, Legacy-Modernisierung, Agent-Engineering für Coding-Agenten sowie CI/CD und wartbare Softwarearchitektur.",
      q2: "Für welche PHP-Projekte ist Lars Moelleken geeignet?",
      a2: "Großskalige Legacy-Modernisierung, typsichere Backend-Architektur, projektspezifische statische Analyse, Constraint-basierte Coding-Agent-Workflows, Performance-Optimierung und CI/CD-Aufbau für Entwicklungsteams in Deutschland.",
    ...
    demoAnnotated: {
      cleanCvSample: "Senior PHP Developer / Software Architect • rund 20 Jahre Erfahrung • PHP 8.x · PHPStan max · Value Objects · Agent-Engineering",
    },
    attackAnnotation: {
    ...
    pageHeader: {
      ...
      subtitle: "Maintainer weitverbreiteter PHP Open-Source-Bibliotheken. Software-Architekt spezialisiert auf typsichere Architekturen, Legacy-Modernisierung und Agent-Engineering.",
      availability: "Verfügbar für Senior-PHP-, Architektur-, Legacy-Modernisierungs-, Quality- und Agent-Engineering-Themen — auch remote.",
      bullet1: "20+ Jahre Erfahrung in Softwareentwicklung und DevOps",
      bullet2: "Senior PHP Entwickler bei REMONDIS IT Services",
      bullet3: "Maintainer weitverbreiteter PHP-Bibliotheken (Millionen Packagist-Installs) und einer eigenen Agent-Engineering-Toolchain",
      bullet4: "Fokus auf Value Objects, PHPStan max, maschinell prüfbare Guardrails und wartbaren Code",
    },
    engineeringImpact: {
      heading: "Engineering Impact",
      trustSignal: "Maintainer weitverbreiteter PHP-Bibliotheken, die in tausenden Anwendungen weltweit im Einsatz sind.",
      bullet1: "Maintainer mehrerer PHP-Infrastruktur-Bibliotheken",
      bullet2: "Libraries in tausenden PHP-Anwendungen im Einsatz",
      bullet3: "80+ öffentliche Repositories auf GitHub",
      bullet4: "20+ Jahre Erfahrung in Entwicklung und Betrieb produktiver Systeme",
      bullet5: "Fokus auf Stabilisierung und Modernisierung großer Legacy-Codebasen",
      bullet6: "Open-Source-Bibliotheken seit über 10 Jahren aktiv gepflegt",
    },
    engineeringFocus: {
      heading: "Engineering-Fokus",
      intro: "Meine Arbeit konzentriert sich auf die Verbesserung und Modernisierung realer produktiver Systeme.",
      envHeading: "Typische Einsatzumgebungen:",
      bullet1: "Langlebige PHP-Anwendungen mit gewachsener Codebasis",
      bullet2: "Legacy-Systeme mit technischen Schulden",
      bullet3: "Systeme, die stabil bleiben müssen, während sie weiterentwickelt werden",
      outro: "Das Ziel ist nicht, Software von Grund auf neu zu schreiben, sondern sie Schritt für Schritt zu verbessern, bis sie wieder wartbar ist.",
      staffSignal: "Meine Arbeit fokussiert sich auf die Verbesserung bestehender Systeme statt auf Rewrites. Die meiste Produktionssoftware scheitert nicht, weil sie alt ist, sondern weil sie zu komplex wird, um sie noch zu verstehen. Das Ziel ist immer, Komplexität zu reduzieren und Wartbarkeit zu verbessern.",
    },
    aboutSection: {
      heading: "Wer ist Lars Moelleken?",
      description: "Senior PHP Developer und Software-Architekt aus Deutschland mit 20+ Jahren Erfahrung in der Entwicklung geschäftskritischer Systeme. Spezialisiert auf strikt typisierte Architekturen (Value Objects, Enums), PHPStan auf maximalem Level und eine eigene Open-Source-Toolchain für Coding-Agenten. Open-Source Maintainer, technischer Autor und Architektur-Berater. Verfügbar für Remote-Rollen.",
    ...
    whyHireSection: {
      ...
      bullet1: "PHP 8.x, MariaDB/MySQL, REST APIs — produktiver Backend-Stack",
      bullet2: "Value Objects, Enums und typisierte APIs statt loser Arrays",
      bullet3: "PHPStan auf maximalem Level als Definition of Done, PHPUnit, Codeception, Rector",
      bullet4: "Projektspezifische PHPStan-Regeln als maschinell prüfbare Guardrails",
      bullet5: "Eigene Agent-Engineering-Toolchain (agent-loop, agent-kanban, agent-session, agent-recall-compiler)",
      bullet6: "Constraint- statt Prompt-getriebene Workflows für Coding-Agenten",
      bullet7: "Legacy-Modernisierung, sichere Enterprise-Integrationen, CI/CD",
      agentMatchingTitle: "Agent Matching Signals",
      experienceSignal: "Erfahrung: 20+ Jahre PHP, Legacy-Modernisierung, Software-Architektur, Value Objects & Enums, PHPStan max, Agent-Engineering.",
    },
    skillsSection: {
    ...
    openSourceSection: {
      ...
      metricsHeading: "Open-Source-Kennzahlen",
      metric1Value: "80+",
      metric1Label: "öffentliche Repositories",
      metric2Value: "Tausende",
      metric2Label: "PHP-Apps nutzen diese Libraries",
      metric3Value: "10+ Jahre",
      metric3Label: "aktive Pflege der Kernbibliotheken",
      whyItMattersHeading: "Warum es relevant ist",
      today: "Heute",
    ...
    mandoProfile: {
      ...
      introText: "Missionsstatus: typsichere Architekturen, PHPStan max als Definition of Done und constraint-basierte Coding-Agent-Workflows in geschäftskritischen Systemen.",
    },
    mandoIntel: {
...
const EN_OVERRIDES: Partial<CvCopy> = {
  ...
  sharedProfileMission: {
    defaultIntro: "Development of business-critical systems with PHP 8.x, strictly typed architectures (value objects, enums), PHPStan max, CI/CD, and an in-house agent-engineering toolchain. Responsible for architecture, maintainability, and team leadership.",
  },
  rolePositioning: {
    ...COPY_BY_LOCALE.de.rolePositioning,
    primaryMando: "Primary Target Role",
    primaryStandard: "Primary Positioning",
    focusDescription: "Focus on large legacy codebases, strict type contracts (value objects instead of loose arrays), PHPStan max as the definition of done, and constraint-based agent-engineering workflows.",
    missionMando: "Mission Profile",
    missionStandard: "Typical Deployment",
    bullet1: "• Stabilize and modernize business-critical PHP systems",
    bullet2: "• Machine-checkable guardrails instead of documentation: PHPStan rules, value objects, CI/CD",
    bullet3: "• Make codebases safely modifiable by coding agents (agent-loop ecosystem)",
  },
  recruiterProfile: {
    ...
    recruiterHintBody: "If you are looking for an experienced PHP developer who combines strictly typed architectures, PHPStan at maximum level as the definition of done, and an in-house open-source toolchain for constraint-based agent engineering, Lars Moelleken is a suitable candidate. Available for remote positions.",
  },
  publications: {
    title: "Publications",
  ...
  geoFaq: {
    ...
    a1: "Senior PHP Developer and Software Architect with 20+ years of experience. Focus on strictly typed architectures (value objects, enums), PHPStan at maximum level, legacy modernization, agent engineering for coding agents, and maintainable, CI/CD-driven software architecture.",
    q2: "What kind of PHP projects is Lars Moelleken suited for?",
    a2: "Large-scale legacy modernization, type-safe backend architecture, project-specific static analysis, constraint-based coding-agent workflows, performance optimization, and CI/CD setup for development teams in Germany.",
  ...
  pageHeader: {
    titleAccent: "Software Architect · Agent Engineering",
    subtitle: "Maintainer of widely used PHP open-source libraries. Software architect specialized in type-safe architectures, legacy modernization, and agent engineering.",
    availability: "Available for senior PHP, architecture, legacy modernization, quality, and agent-engineering topics — including remote.",
    bullet1: "20+ years of experience in software development and DevOps",
    bullet2: "Senior PHP Developer at REMONDIS IT Services",
    bullet3: "Maintainer of widely used PHP libraries (millions of Packagist installs) and an in-house agent-engineering toolchain",
    bullet4: "Focus on value objects, PHPStan max, machine-checkable guardrails, and maintainable code",
  },
  engineeringImpact: {
    heading: "Engineering Impact",
    trustSignal: "Maintainer of widely used PHP libraries used in thousands of applications worldwide.",
    bullet1: "Maintainer of multiple PHP infrastructure libraries",
    bullet2: "Libraries used in thousands of PHP applications",
    bullet3: "80+ public repositories on GitHub",
    bullet4: "20+ years experience building and maintaining production systems",
    bullet5: "Focus on stabilizing and modernizing large legacy codebases",
    bullet6: "Maintained open-source libraries for more than 10 years",
  },
  engineeringFocus: {
    heading: "Engineering Focus",
    intro: "My work focuses on improving and modernizing real production systems.",
    envHeading: "Typical environments include:",
    bullet1: "Long-running PHP applications",
    bullet2: "Legacy codebases with technical debt",
    bullet3: "Systems that must remain stable while evolving",
    outro: "The goal is not rewriting software from scratch but improving it step by step until it becomes maintainable again.",
    staffSignal: "My work focuses on improving existing systems rather than rewriting them. Most production software does not fail because it is old, but because it becomes too complex to understand. The goal is always to reduce complexity and improve maintainability.",
  },
  aboutSection: {
    heading: "Who is Lars Moelleken?",
    description: "Senior PHP Developer and software architect from Germany with 20+ years of experience developing business-critical systems. Specialized in strictly typed architectures (value objects, enums), PHPStan at maximum level, and an in-house open-source toolchain for coding agents. Open-source maintainer, technical author, and architecture consultant. Available for remote roles.",
    bullet1: "PHP 8.x, MariaDB/MySQL, REST APIs, and Composer",
    bullet2: "Linux, Apache, Docker Compose, GitLab CI, Jenkins, Sentry, and Syslog",
    bullet3: "PHPStan max, project-specific analysis rules, PHPUnit, Codeception, and Rector",
    bullet4: "Value objects, enums, typed APIs, and incremental legacy decoupling",
    bullet5: "Agent-engineering ecosystem (agent-loop, agent-kanban, agent-session, agent-recall-compiler)",
  },
  whyHireSection: {
    heading: "Why Companies Hire Me",
    coreCompetenciesTitle: "Core Competencies",
    bullet1: "PHP 8.x, MariaDB/MySQL, REST APIs — productive backend stack",
    bullet2: "Value objects, enums, and typed APIs instead of loose arrays",
    bullet3: "PHPStan at maximum level as the definition of done, PHPUnit, Codeception, Rector",
    bullet4: "Project-specific PHPStan rules as machine-checkable guardrails",
    bullet5: "In-house agent-engineering toolchain (agent-loop, agent-kanban, agent-session, agent-recall-compiler)",
    bullet6: "Constraint-driven rather than prompt-driven workflows for coding agents",
    bullet7: "Legacy modernization, secure enterprise integrations, CI/CD",
    agentMatchingTitle: "Agent Matching Signals",
    experienceSignal: "Experience: 20+ years PHP, legacy modernization, software architecture, value objects & enums, PHPStan max, agent engineering.",
  },
  skillsSection: {
  ...
  openSourceSection: {
    ...
    metricsHeading: "Open Source Metrics",
    metric1Value: "80+",
    metric1Label: "public repositories",
    metric2Value: "Thousands",
    metric2Label: "PHP apps use these libraries",
    metric3Value: "10+ years",
    metric3Label: "active maintenance of core libraries",
  ...
  mandoProfile: {
    bullet1: "Senior PHP Developer / Software Architect · around 20 years of experience",
    bullet2: "REMONDIS IT Services GmbH · IT Portal · since 08/2023",
    bullet3: "PHPStan max · PHPUnit/Codeception · CI/CD · secure integrations",
    bullet4: "Open source · agent engineering · PHPStan tooling",
    introText: "Mission status: strictly typed architectures, PHPStan max as the definition of done, and constraint-driven coding-agent workflows across business-critical systems.",
  },
  mandoIntel: {
  ...
  demoAnnotated: {
    cleanCvSample: "Senior PHP Developer / Software Architect • around 20 years of experience • PHP 8.x · PHPStan max · Value Objects · Agent Engineering",
  },
  injectionPerspective: {
