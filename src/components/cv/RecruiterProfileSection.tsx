...
export function RecruiterProfileSection() {
  return (
    <section aria-labelledby="recruiter-heading" className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
      <h2 id="recruiter-heading" className="text-2xl font-bold mb-6 border-b pb-4">{UI_TEXT.recruiterProfile.title}</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          <div className="mb-6">
            <h4 className="text-sm font-mono text-gray-500 uppercase mb-2">{UI_TEXT.recruiterProfile.focusTitle}</h4>
          ...
          <div>
            <h4 className="text-sm font-mono text-gray-500 uppercase mb-2">{UI_TEXT.recruiterProfile.suitableRoles}</h4>
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
        <p className="text-sm text-gray-600 font-mono"><strong className="text-gray-900 uppercase">{UI_TEXT.recruiterProfile.recruiterHint}</strong> {UI_TEXT.recruiterProfile.recruiterHintBody}</p>
      </div>
    </section>
  );
}
